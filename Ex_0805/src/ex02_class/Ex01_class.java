...
public class Ex01_class {
	...
	public static void main(String[] args) {
		...
		//new는 메모리에 객체를 생성하기 위한 공간을 할당받는 키워드
		...
		//int,boolean등 기본 자료형과 String같은 참조자료형도 가능하지만
		//사용자가 만든 객체로도 반환이 가능하다. 
		//아무것도 반환하지 않을 때는 void 
		
		//메서드의 이름짓기 
		//기능을 명화갛게 설명해줄 수 있는 이름이 좋다.
